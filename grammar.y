/* $Id: grammar.y,v 1.1 2024-05-03 14:35:03 behdad Exp $
 *
 *---------------------------------------------------------
...
/*---------------------------------------------*/
/* are we still looking for the first comment? */
/*---------------------------------------------*/
boolean first_comment;
/*------------------------------------------*/
/* last comment found at start of func body */
/*------------------------------------------*/
static char *body_comment = NULL;
%}
%%
...
type_specifier
	...
	| T_TYPEDEF_NAME
	{
		...
		s->valtype == SYMVAL_ENUM ? s->value.enum_list : (EnumeratorList *)NULL);
	}
	;
